package br.com.pe.urbana.cobranca.util.boleto.bopepo;
...
public class BopepoEmissorBoleto implements EmissorBoleto {
	...
	@Override
	public byte[] gerarBoleto(br.com.pe.urbana.cobranca.model.Cedente cedenteSistema
							, Cobranca2 cobrancaSistema) {
	...
	@Override
	public File gerarBoletoEmArquivo(String arquivo, br.com.pe.urbana.cobranca.model.Cedente cedenteSistema, Cobranca2 cobrancaSistema) {
		Boleto boleto = criarBoleto(cedenteSistema, cobrancaSistema);
	...
	private Boleto criarBoleto(br.com.pe.urbana.cobranca.model.Cedente cedenteSistema, Cobranca2 cobrancaSistema) {
	...
	private ContaBancaria criarContaBancaria(br.com.pe.urbana.cobranca.model.Cedente cedenteSistema) {
	...
	private Titulo criarTitulo(ContaBancaria contaBancaria, Sacado sacado, Cedente cedente
			, br.com.pe.urbana.cobranca.model.Cobranca2 cobrancaSistema) {
