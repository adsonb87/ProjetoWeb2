...
public class ContaBancaria implements Serializable {
	...
	@Id
	@Column(name = "ID")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "id_Sequence_conta_bancaria")
	@SequenceGenerator(name = "id_Sequence_conta_bancaria", sequenceName = "ID_SEQ")
